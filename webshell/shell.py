...
<head>
  ...
  <style>
    body { background-color: #000; color: #eee; font-family: monospace; display: flex; flex-direction: column; height: 100vh; margin: 0; }
    ...
    #commandInput { background-color: #000; color: #eee; border: none; flex-grow: 1; padding: 5px; margin-right: 5px; }
  </style>
</head>
<body>
